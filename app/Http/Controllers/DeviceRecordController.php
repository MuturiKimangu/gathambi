...
//                        }
    ...
    public function sendSms($guardian, $face_record, $time, $sms_time,$student)
    {
        ...
        if ($sms_time == 'first') {
            ...
            $message1 = "Dear $guardian->fname, your child " . $face_record->student->first_name . " " . $face_record->student->surname . "  UPI:" . $face_record->student->upi_no . " has clocked at school at $new_time" . $templete1[0];
            // dd($templete);
        } else {
